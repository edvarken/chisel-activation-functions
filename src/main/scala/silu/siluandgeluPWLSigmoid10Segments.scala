...
/**
  ...
  * sigmoid is approximated using 10 segments each linearly interpolated as y = m*x + q, using the local slope m and y-intercept q.
...
class siluandgeluPWLSigmoid10Segments extends Module {
    ...
    when (a(14,0) === "b00000000_0000000".U ) { // in_a = +-0
        ...
        when (a_int >= "b100".U) { // one of two segments
