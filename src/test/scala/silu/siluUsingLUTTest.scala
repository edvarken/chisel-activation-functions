...
class siluUsingLUTTest extends AnyFreeSpec with Matchers {
    "siluUsingLUTTest should correctly apply an approximate SiLU value using a Lookup Table with 128 entries on BF16 input numbers" in {
    ...
    "siluUsingLUTTest should correctly apply an approximate SiLU value using a Lookup Table with 256 entries on BF16 input numbers" in {
